...
void Troop::setAgi(int agi)
{
    m_agi = agi;
}

int Troop::speed() const
{
    return m_speed;
}

void Troop::setSpeed(int speed)
{
    m_speed =speed;
}
...
void Troop::write(QJsonObject &json) const
{
    ...
    json["MOVED"] = m_statList->at(21).toInt();
    json["ATTACKED"] = m_statList->at(22).toInt();
