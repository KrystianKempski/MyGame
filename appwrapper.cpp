...
void AppWrapper::initialize()
{
 ...
 //   connect(&m_gameLogic,&GameLogic::dataChanged,ds,&DataSource::changeItem);
    ...
    connect(&m_gameLogic,&GameLogic::dataChanged,&m_troopModelBlue,&TableModelBlue::updateAll);
   ...
   // m_engine.rootContext()->setContextProperty("dataBase",&ds2);

    m_app->setOrganizationName("somename");
    m_app->setOrganizationDomain("somename");
